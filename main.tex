...
\author{Qiqi Wang and Nisha Chandramoorthy}
...
\end{figure}
\begin{comment}In Figure 4, the solid line appears only to have one local maximum, which is shown as the fixed point on the left plot of this figure. The two fixed points of the 2-time-iterate of the Lorenz map, shown on the right plot of this figure, both appear to correspond to the local maxima of the dashed curve in Figure 4.\end{comment}
...
We conclude with an example that illustrates that assuming the 
