...
examples in which numerical error due to computation in double-precision floating point arithmetic cause significant change in the stationary probability distribution on the attractor. The plucked tent map adds to this list of examples by exhibiting a mechanism to produce an extreme non-smooth response (Supplementary Material section \ref{sec:pluckedTentMap}).
