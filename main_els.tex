...
\item We show through examples that it is theoretically possible to significantly alter the statistics of a chaotic system, e.g. the earth's climate, by minor parameter perturbations.
\end{highlights}
...
{\em Acknowledgments:} The authors are grateful to Prof. Tim Sauer and Prof. John Williams for comments on the paper.
\\
